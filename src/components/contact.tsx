          ...
          >
            ...
            <label htmlFor="email" className="flex flex-col">
              ...
              <input
                ...
                value={form.email}
                onChange={handleChange}
                placeholder="manavpandya7603@gmail.com"
            ...
            <button
              ...
              className="bg-tertiary py-3 px-8 outline-none w-fit text-white font-bold shadow-md shadow-primary rounded-xl disabled:bg-tertiary/20 disabled:text-white/60 cursor-pointer hover:shadow-accent-glow transition-all duration-300 ripple"
              disabled={loading}
              aria-disabled={loading}
            >
              {/* check loader state */}
